...
import TaraLogo from "../../assets/images/lizatoken.png"
                ...
                <WrapModal >
                    ...
                    <Spliterr>
                        <div style={{ display: "flex", alignItems: "center", }}>
                            <img src={LizaLogo} />
                            <SubHeading p="0 0 0 10px"> Tara Balance :</SubHeading>
                        </div>
                        <SubHeading p="0 0 0 10px"> {truncateDecimal(getBalance)} Tara</SubHeading>
